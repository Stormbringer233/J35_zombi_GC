...
fn draw_arc(cx:f32, cy:f32, angle_deb : f32, angle_fin : f32, precision : u32, thickness : f32, radius : f32, color : Color) {
...
pub fn draw_round_rectangle_line(x:f32, y:f32, width : f32, height : f32, radius : f32, thickness : f32, color : Color) {
    ...
    while n < 4 {
        ...
        draw_arc(arc_pos[n][0], arc_pos[n][1], a0, a1, precision, thickness, radius, color);
        draw_line(line_pos[n][0], line_pos[n][1], line_pos[n][2], line_pos[n][3], thickness, color);
        n += 1;
    }
}
