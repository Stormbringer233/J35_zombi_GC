...
impl WidgetColor {
    pub fn new(compo : (LightComposite, LightComposite, LightComposite, LightComposite)) -> Self {
    ...
    pub fn composits(&self) -> (FullComposite, FullComposite, FullComposite, FullComposite) {
        (self.background, self.foreground, self.top_line, self.bottom_line)
    }
}
...
impl Colortheme {
    ...
    pub fn get_theme(&self, state : State) -> (FullComposite, FullComposite, FullComposite, FullComposite) {
        match state {
